...
export const expansionNiches: ExpansionNiche[] = [
  {
    ...
    hook: 'Join the Pampered Pet Club',
    valueProp: 'Never miss a groom! Scan to get automated reminders and a special treat for your furry friend.',
  ...
  },
  {
    ...
    hook: 'Join the Shine Society',
    valueProp: 'Protect your craft. Scan to lock in seasonal detailing alerts and Connection Guard member benefits.',
  ...
  },
  {
    ...
    hook: 'Join the Coffee Circle',
    valueProp: 'Giving every customer a reason to come home. Scan to join our loyalty circle and get your 10th cup on us.',
  ...
  },
  {
    ...
    hook: 'Join the Baked Fresh Club',
    valueProp: 'Fresh from the oven alerts! Scan to join and get a special treat on your birthday.',
  ...
  },
  {
    ...
    hook: 'Join the Inner Circle',
    valueProp: 'Your wellness journey starts here. Scan for intro class offers and exclusive workshop alerts.',
